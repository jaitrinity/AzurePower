export class Constant{
    ...
    // PROD
    public static phpServiceURL = "/AzurePower/";
    // public static phpServiceURL = "http://www.trinityapplab.co.in/AzurePower/";
    ...
    public static AZURE_PRIVATE_KEY = "AZUREPRIVATEKEY";
